...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameDB.Core.Models.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("GameDB.Core.Models.ImportJob", b =>
                {
                    ...
                    b.Property<int>("EgsOffersUpdated")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("GogOffersUpdated")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SteamOffersUpdated")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameDB.Core.Models.ImportJobLog", b =>
                {
                    b.Property<int>("ImportJobLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ImportJobLogId"));
                    ...
                    b.HasKey("ImportJobLogId");

                    b.HasIndex("ImportJobId", "Timestamp");
            ...
            modelBuilder.Entity("GameDB.Core.Models.ImportJobLog", b =>
                {
                    b.HasOne("GameDB.Core.Models.ImportJob", "ImportJob")
                        .WithMany("Logs")
