...
public record PipelineStatus(
    ...
    int ErrorCount,
    int IgdbCollected,
    int EligibleForImport,
    int SkippedAlreadyImported,
    int SkippedNoStoreOffers,
    int SkippedInvalidStoreIds,
    int SkippedDuplicateTitles,
    int? RequestedLimit,
    List<int>? RequestedIgdbGameIds,
    bool RequestedOverwriteExisting,
    DateTime StartedAt,
